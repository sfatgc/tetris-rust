...
impl Figure {
    ...
    pub fn blocks(&self) -> Result<[Position; 4], String> {
        match self.figure_type % 2 {
            ...
            1 => {
                Ok(self.blocks_square())
            },
        _ => { 
            Err("Figure::figure_type % 2 is not 0 or 1".to_string())
        },
        }
    }
    ...
    fn blocks_line(&self) -> [Position; 4] {
        ...
        [Position::new(p_x, p_y), Position::new(p_x + 1, p_y), Position::new(p_x + 2, p_y), Position::new(p_x + 3, p_y)]
    }
    ...
    fn blocks_square(&self) -> [Position; 4] {
        ...
        let p_y: usize = self.position.get_y();
        [
            Position::new(p_x, p_y), Position::new(p_x + 1, p_y),
            Position::new(p_x, p_y + 1), Position::new(p_x + 1, p_y + 1)
        ]
    }
}
